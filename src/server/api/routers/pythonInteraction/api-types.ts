...
export interface components {
  schemas: {
    ...
    InputERC7730Descriptor: {
       ...
       */
      context:
        | components["schemas"]["InputContractContext"]
        | components["schemas"]["InputEIP712Context"];
      /**
       * Metadata Section
    ...
    InputFieldDefinition: {
      ...
      params?:
        | (
            ...
            | components["schemas"]["InputNftNameParameters"]
            | components["schemas"]["InputDateParameters"]
            | components["schemas"]["InputUnitParameters"]
            | components["schemas"]["InputEnumParameters"]
          )
        | null;
    };
    /**
